...
export default function Aws(props: SVGProps<SVGSVGElement>): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <path d="M18.38 14.06c-.19.14-.16.33.05.3.71-.09 2.28-.27 2.56.09s-.31 1.83-.58 2.49c-.08.2.1.28.28.13a3.9 3.9 0 0 0 1.23-3.34 3.94 3.94 0 0 0-3.54.33z"></path>
    </svg>
  );
}
