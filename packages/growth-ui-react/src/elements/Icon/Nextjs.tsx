...
export default function Nextjs(props: SVGProps<SVGSVGElement>): JSX.Element {
  const color = props.color ? `var(--color-${props.color})` : 'var(--icon-color)';

  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 506.68 306.34" height="25" width="25" {...props} color={color}>
      <title>nextjs</title>
